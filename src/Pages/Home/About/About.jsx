...
const About = () => {
    return (
        <div className='lg:flex justify-around'>
            <div data-aos="fade-right" className='h-2/3'>
                <img src="https://i.ibb.co/YWFCFcj/mh-itch.jpg" width={400} alt="" />
            </div>
            <div data-aos="fade-left" className='lg:w-2/4 my-auto px-4'>
                <h2 className='text-center text-yellow-700 text-2xl font-bold my-4'>About Us</h2>
